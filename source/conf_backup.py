...
# -*- coding: utf-8 -*-
#
# ocp documentation build configuration file, created by
...
exclude_patterns = ['setup.py', 'tests/test_*']
...
##    'stickysidebar': True,
##    'externalrefs': True,
#    'sidebarbgcolor': '#2B2F34',
#    'sidebartextcolor': '#F6F3F2',
#    'sidebarlinkcolor': '#32A0A5',
#    'footerbgcolor': '#2B2F34',
#    'codebgcolor': '#2B2F34',
#    'codetextcolor': '#F6F3F2',
#}

html_logo = "_static/ouroboros.svg"
